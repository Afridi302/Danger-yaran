...
\033[1;93m░░░╚═╝░░░╚══════╝╚══════╝╚═╝░░╚═╝
\033[1;92m●●●●●●●●●●●●●●●●●●●●<><>●●●●●●●●●●●●●●●●●●●●
\033[1;93m              OWNER:VEER ASHIQ
\033[1;95m                 MAST AFRIDI 
\033[1;93m   ●●<>MOST WELCOME JEGRIIII PA KHER RAGHLY<>●●"
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;94mLOGIN WITH FACEBOOK \x1b[1;96m[☆]' )
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;92m[!] \033[1;91mIt seems that your account has a CP"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
